...
# read excel 2021
df_districts2021 = excelparse.read_file(config.data_dir + "2024-02_Daten_Wahl-Atlas.xlsx", False)
df_electoral_districts2021 = excelparse.read_file(config.data_dir + "2024-02_Daten_Wahl-Atlas.xlsx", True)
